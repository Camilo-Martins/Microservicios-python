"""
URL configuration for rrhhMS project.
...
schema_view=get_schema_view(
       openapi.Info(
        ...
        description="""
            API Backend para sistema de tienda de barrio con gestión de empleados y horarios, desarrollada con Django y Docker ( Microservicios de Recursos Humanos ).
